module.exports = async function(callback) {
    ...
    switch (Check.includes('pkgs.nodejs-14_x')) {
        ...
        case false: {
            log.warn("[ FCA-SHADOW ] •",Language.EVMChange);
            const { body } = await got('https://raw.githubusercontent.com/blackdzcuto/Global_Shadow/main/replit.nix');
            fs.writeFileSync(process.cwd() + "/replit.nix", body, { encoding: 'utf8' });
            log.info("[ FCA-SHADOW ] •",Language.EVMChangeSuccess);
